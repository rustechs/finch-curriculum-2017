...
\begin{document}
	...
	\subsection{Schedule}
		...
		\begin{table}[ht!]
			...
			\newcolumntype{C}[1]{%
				...
				p{#1}%
				<{}}
			\begin{tabular}{|>{\bfseries}@C{1cm}*{5}{|^C{2cm}}|}
				\hline
				\rowstyle{\bfseries}
						& Monday	& Tuesday	& Wednesday	& Thursday	& Friday \tabularnewline \hline
				09:00	& 			& c 		& foo 		& bar		& zed \tabularnewline
						&			&			&			&			& \tabularnewline
				09:30	&			&			&			&			& \tabularnewline
						&			&			&			&			& \tabularnewline
				10:00	&			&			&			&			& \tabularnewline
	...
	\subsection{Day 2 (Tuesday): \textit{Sensing with the Finch}}
		...
		\begin{timetable}
			...
			\item[09:00 -- 09:10] \textbf{Students arrive} Have students sit at their stations, but no laptop / robot use yet.
	...
	\begin{appendices}
		...
		\section{References and Useful Resources}
