...
\setlist[description]{labelwidth=7.75em,leftmargin=!,labelindent=2em}

\newenvironment{timetable}
{
	\setlist[description]{leftmargin=!,labelwidth=7.75em,labelindent=0em,itemindent=2em,listparindent=2em,font=\textbf}
...
\begin{document}
	...
	\subsection{Day 1 (Monday): \textit{Introduction to Robotics / Finch Basics}}
		...
		\begin{timetable}
			\item[08:00 -- 09:00] \textbf{Prep} -- Queue up ``Day 1 Slides'' presentation (see \hyperref[sec:apdx-slides]{Appendix \ref*{sec:apdx-slides}: Presentation Slides}). Arrange seats in quasi-rows facing the projector screen.
			...
			\item[09:15 -- 09:30] \textbf{Student introductions} -- (Slide 5) The usual ice breaker: names, age, prior programming / robotics exposure (just for reference, emphasize that no prior experience is needed), favorite animal, etc.
			
			\item[09:30 -- 10:30] \textbf{Intro to Robotics presentation} -- (see ???) nothing technical, just a bit of terminology and discussion to get the students thinking about robots. A selection of particularly interesting and insightful robot videos on YouTube (see ???)\todo{create a playlist?} closes out the session.
			
			\item[10:30 -- 10:45] \textbf{Bathroom / Snack Break}
			
			\item[10:45 -- 11:15] \textbf{Guided Intro to Scratch \& Finch} -- \todo{add grouping students up} see \todo{reference second slide set}
			
			\item[11:15 -- 11:50] \textbf{Exploring Scratch \& Finch Basics} -- student groups continue to work \todo{finish this thought}
	...
	\subsection{Day 2 (Tuesday): \textit{Sensing with the Finch}}
		...
		\begin{timetable}
			...
			\item[08:00 -- 09:00] \textbf{Prep} -- Assemble the robot maze... be creative with the layout. The larger the better, so long as the floorspace allows.
			
			\item[09:00 -- 09:10] \textbf{Students arrive}
			
			\item[09:10 -- 09:15] \textbf{???} -- \todo{maze rules, what to do today, etc.}
	...
	\subsection{Day 4 (Thursday): \textit{Final Projects / Robotics Institute Tour}}
		...
		\begin{timetable}
			...
			\item[10:00 -- 10:05] \textbf{Final Project Announcement} \todo{link to Thursday slide}
	...
	\subsection{Day 5 (Friday): \textit{Final Projects (cont.) / Parents Visit}}
		...
		\begin{timetable}
			...
			\item[11:20 -- 11:25] \textbf{Parents arrive}
			
			\item[11:25 -- 11:30] \textbf{Quick summary of course for parents}
			
			\item[11:30 -- 11:55] \textbf{Student final project presentations} -- \todo{describe}
			
			\item[11:55 -- 12:05] \textbf{``Continuing Robotics at Home''} -- \todo{slide 9 of friday presentation}
	...
	\begin{appendices}
		...
		\section{Bibliography and Useful Resources}
